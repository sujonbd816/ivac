      ...
      , ae = async () => {
        try {
            ...
            const je = $
              ...
              , Pt = typeof je == "object" && typeof je.status == "number" ? je.status : 422;
            (Pt === 401 || Pt === 419) && (u({
                message: mt,
                type: "error"
            }),
    ...
    const {language: l, translations: s} = ut()
      ...
      , x = async () => {
        ...
        try {
            ...
            const I = q
              , Q = typeof I == "object" && (I != null && I.message) ? I.message : "Failed. Please try again later."
              , re = typeof I == "object" && typeof I.status == "number" ? I.status : 422;
            (re === 401 || re === 419) && (p({
                message: Q,
                type: "error"
            }),
      ...
      , v = async () => {
        try {
            ...
            const B = P
              ...
              , O = typeof B == "object" && typeof B.status == "number" ? B.status : 422;
            (O === 401 || O === 419) && (p({
                message: X,
                type: "error"
            }),
    ...
    const X = async () => {
        ...
        try {
            ...
            const T = F
              ...
              , Y = typeof T == "object" && typeof T.status == "number" ? T.status : 422;
            (Y === 401 || Y === 419) && (w({
                message: D,
                type: "error"
            }),
    ...
    const O = async () => {
        ...
        try {
            ...
            const V = S
              ...
              , W = typeof V == "object" && typeof V.status == "number" ? V.status : 422;
            (W === 401 || W === 419) && (w({
                message: te,
                type: "error"
            }),
      ...
      , v = async () => {
        ...
        try {
            ...
            const O = X
              ...
              , I = typeof O == "object" && typeof O.status == "number" ? O.status : 422;
            (I === 401 || I === 419) && (g({
                message: q,
                type: "error"
            }),
    ...
    const w = async () => {
        try {
            ...
            const q = O
              ...
              , Q = typeof q == "object" && typeof q.status == "number" ? q.status : 422;
            (Q === 401 || Q === 419) && (p({
                message: I,
                type: "error"
            }),
    ...
    const P = async () => {
        ...
        try {
            ...
            const J = Y
              ...
              , V = typeof J == "object" && typeof J.status == "number" ? J.status : 422;
            (V === 401 || V === 419) && (x({
                message: S,
                type: "error"
            }),
      ...
      , B = async () => {
        ...
        try {
            ...
            const F = se
              ...
              , D = typeof F == "object" && typeof F.status == "number" ? F.status : 422;
            (D === 401 || D === 419) && (x({
                message: T,
                type: "error"
            }),
      ...
      , N = async () => {
        ...
        try {
            ...
            const se = ie
              ...
              , T = typeof se == "object" && typeof se.status == "number" ? se.status : 422;
            (T === 401 || T === 419) && (v({
                message: F,
                type: "error"
            }),
    ...
    const [l,s] = j.useState(null)
      ...
      , v = async () => {
        ...
        try {
            ...
            M.status_code === 200 ? N((E = M == null ? void 0 : M.data) == null ? void 0 : E.slot_available, (_ = M == null ? void 0 : M.data) == null ? void 0 : _.ivac_fees) : M.status_code === 401 ? (localStorage.clear(),
            window.location.href = "/") : N(!1)
        } catch (M) {
            M.status === 401 ? (localStorage.clear(),
            window.location.href = "/") : N(!1)
        } finally {
            u(!1)
        }
    ...
    const O = async () => {
        ...
        try {
            ...
            const le = W
              ...
              , ae = typeof le == "object" && typeof le.status == "number" ? le.status : 422;
            (ae === 401 || ae === 419) && (N({
                message: ee,
                type: "error"
            }),
      ...
      , q = async () => {
        ...
        try {
            ...
            const Y = D
              ...
              , S = typeof Y == "object" && typeof Y.status == "number" ? Y.status : 422;
            (S === 401 || S === 419) && (N({
                message: J,
                type: "error"
            }),
    ...
    j.useEffect( () => {
        ...
        if (oe)
            try {
                ...
                le(ye.visit_purpose || le(ye.visit_purpose || "I AM IN NEED OF EMERGENCY MEDICAL TREATMENT NOW."),
                S(ye.visa_type || "13"),
                me(ye.ivac_name || "IVAC, Dhaka (JFP)"),
                se(ye.ivac_id || "IVACJFP|17")
            } catch {
    ...
    const De = async () => {
        try {
            ...
            const ye = oe
              ...
              , $e = typeof ye == "object" && typeof ye.status == "number" ? ye.status : 422;
            ($e === 401 || $e === 419) && (w({
      ...
      , Ne = async oe => {
        try {
            ...
            const Qe = ye
              ...
              , $ = typeof Qe == "object" && typeof Qe.status == "number" ? Qe.status : 422;
            ($ === 401 || $ === 419) && (w({
                message: "Unauthorized, session timed out",
                type: "error"
            }),
...
` + D[0],
            ...
            const D = T
              ...
              , J = typeof D == "object" && typeof D.status == "number" ? D.status : 422;
            (J === 401 || J === 419) && (m({
                message: Y,
                type: "error"
            }),
        ...
        if (ie) {
            ...
            try {
                ...
                const ne = de
                  ...
                  , Oe = typeof ne == "object" && typeof ne.status == "number" ? ne.status : 422;
                (Oe === 401 || Oe === 419) && (v({
                    message: Ve,
                    type: "error"
                }),
        ...
        if (ne && Ve)
            try {
                ...
                const Re = Oe
                  ...
                  , lt = typeof Re == "object" && typeof Re.status == "number" ? Re.status : 422;
                (lt === 401 || lt === 419) && ha(l),
                v({
                    message: De,
                    type: "error"
        ...
        (async () => {
            ...
            try {
                ...
                const Na = st
                  ...
                  , Pn = typeof Na == "object" && typeof Na.status == "number" ? Na.status : 422;
                (Pn === 401 || Pn === 419) && (h({
                    message: kn,
                    type: "error"
                }),
    ...
    const ga = async Te => {
        ...
        try {
            ...
            const Le = Pe
              ...
              , Et = typeof Le == "object" && typeof Le.status == "number" ? Le.status : 422;
            (Et === 401 || Et === 419) && (h({
                message: Ue,
                type: "error"
            }),
      ...
      , La = async () => {
        ...
        try {
            ...
            const Pe = ge
              ...
              , Ue = typeof Pe == "object" && typeof Pe.status == "number" ? Pe.status : 422;
            (Ue === 401 || Ue === 419) && (h({
                message: Le,
                type: "error"
            }),
